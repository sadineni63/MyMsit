$(document).on('ready', function () {
    ...
    var addTask = function (task) {
        if (task) {
            ...
            $('#newList').append('<a href="#finish" class="" id="item"><li class="list-group-item">' + task.task + '<span class="arrow pull-down"><i class="glyphicon glyphicon-arrow-down"></span></li></a>');
        }
    };
    ...
    $(document).on('click', '#inProgress', function (e) {
        ...
        var task = this;
        task.id = "archived";
        var changeIcon = task.outerHTML.replace('glyphicon-arrow-down', 'glyphicon-remove');
        advanceTask(task);
    ...
    var populateLists = function () {
        ...
        for (var i = 0; i < storedList.length; i++) {
            if (storedList[i].id === 'new') {
                $('#newList').append('<a href="#finish" class="" id="item"><li class="list-group-item">' + storedList[i].task + '<span class="arrow pull-down"><i class="glyphicon glyphicon-arrow-down"></span></li></a>');
            } else if (storedList[i].id === 'inProgress') {
                $('#currentList').append('<a href="#finish" class="" id="inProgress"><li class="list-group-item">' + storedList[i].task + '<span class="arrow pull-down"><i class="glyphicon glyphicon-arrow-down"></span></li></a>');
            } else {
                $('#archivedList').append('<a href="#finish" class="" id="archived"><li class="list-group-item">' + storedList[i].task + '<span class="arrow pull-down"><i class="glyphicon glyphicon-remove"></i></span></li></a>');
            }
        }
    };
