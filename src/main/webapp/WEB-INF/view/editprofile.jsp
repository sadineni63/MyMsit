...
<body>
	<div class="container">
		...
		<script src="resources//plugins/bootstrap-select.min.js"></script>
		<script src="resources//codemirror/jquery.codemirror.js"></script>
		<script src="resources//beautifier.js"></script>
		<script>
		...
		<div id="upgradeModal" class="modal hide">
			...
			<div class="modal-body">
				...
				<p class="text-center">
					<img src="resources//assets/i_visa.png" width="50" alt="visa"> <img
						src="resources//assets/i_mc.png" width="50" alt="mastercard"> <img
						src="resources//assets/i_amex.png" width="50" alt="amex"> <img
						src="resources//assets/i_discover.png" width="50" alt="discover"> <img
						src="resources//assets/i_paypal.png" width="50" alt="paypal">
				</p>
			</div>
			<div class="modal-footer pull-center">
		...
		<script src="resources//plugins/bootstrap-pager.js"></script>
	</div>
