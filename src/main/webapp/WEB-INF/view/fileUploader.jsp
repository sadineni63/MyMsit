...
<link rel="stylesheet" type="text/css"
	href="resources/bootstrap-dialog/css/bootstrap-dialog.min.css"/>
<link rel="stylesheet" type="text/css"
	href="resources/css/upload.css"/>
...
<body>
	...
	<script type="text/javascript"
		src="resources/jquery/jquery-2.1.1.js"/></script>
	<script type="text/javascript"
		src="resources/js/bootstrap.js"/></script>
	<script type="text/javascript"
		src="resources/bootstrap-dialog/js/bootstrap-dialog.min.js"/></script>
	<script type="text/javascript"
