				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="details">
								<form role="form" action="create_module?cid=<%=request.getSession().getAttribute("cid")%>" method="post">
								<div class="form-group">
										<label>Week number* :</label> <input type="text"
											required="required" class="form-control" id="week"
											name="week">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="hero-unit">
											<label>No. of tasks</label> <input type="number"
